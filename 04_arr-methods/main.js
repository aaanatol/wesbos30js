document.addEventListener('DOMContentLoaded', () => {
	...
	let filteredInventors = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600);
	...
	const orderedLived = inventors.sort(compareByYearsLived);

	function compareByYearsLived(a, b) {
	...
	const  peopleJoined = people.map(man => man.replace(',', ''));

	console.log(alpha);
	console.table(peopleJoined);
